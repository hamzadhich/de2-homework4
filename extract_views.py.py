...
s3.upload_file(json_lines_file, S3_WIKI_BUCKET, f"datalake/bronze_views/{json_lines_filename}")
print(f"✅ Uploaded processed data to s3://{S3_WIKI_BUCKET}/datalake/bronze_views/{json_lines_filename}")
# %%
